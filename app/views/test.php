...
<div id="main_container">
    ...
    <div id="main_content">
        ...
        <div class="center_content">
            <div class="center_title_bar">Edit User Details</div>
                ...
                <div class="center_prod_box_big">
                    <div class="contact_form">
                        ...
                        <div class="form_row">
                            ...
                            {{ Form::text('firstname', $users->firstname) }}
                        </div>
                        <div class="form_row">
                            {{ Form::label('middlename', 'Middle Name') }}
                            {{ Form::text('middlename', $users->middlename) }}
                        </div>
                        <div class="form_row">
                            {{ Form::label('lastname', 'Last Name') }}
                            {{ Form::text('lastname', $users->lastname) }}
                        </div>
                        <div class="form_row">
                            {{ Form::label('address', 'Address') }}
                            {{ Form::text('address', $users->address) }}
                        </div>
                        <div class="form_row">
                            {{ Form::label('contactno', 'Contact No.') }}
                            {{ Form::text('contactno', $users->contactno) }}
                        </div>

                        <div class="form_row">
                            {{ Form::label('role', 'Assigned Role') }}
                            {{ Form::select('role', $role_options , Input::old('role')) }}
                        </div>
